 ...
 */
public class RandomOp extends Application{
            ...
            public void handle(ActionEvent event) {
                try {
                    ...
                    for(int i = 0; i < rhc_trainingErr.size(); i++) {
                        jg_rhc.addToSeries("Training Error", runs.get(i)[1], rhc_trainingErr.get(i));
                        jg_rhc.addToSeries("Testing Error", runs.get(i)[1], rhc_testingErr.get(i));
                    }
                    jg_rhc.createChart(0.0, 2000.0);*/

                    /*JGraph jg_1 = new JGraph(st, "Back Propagation");
                    for(int i = 0; i < bp_trainingErr.size(); i++) {
                        jg_1.addToSeries("Training Error", runs.get(i)[1], bp_trainingErr.get(i));
                        jg_1.addToSeries("Testing Error", runs.get(i)[1], bp_testingErr.get(i));
                    }
                    jg_1.createChart(0.0, 2000.0);*/
                    ...
                    JGraph jg_sa1 = new JGraph(st, "Simulated Annealing");
                    for(int i = sa_trainingErr.size()/2 - 1; i < sa_trainingErr.size(); i++) {
                        jg_sa1.addToSeries("Training Error", runs.get(i)[1], sa_trainingErr.get(i));
                        jg_sa1.addToSeries("Testing Error", runs.get(i)[1], sa_testingErr.get(i));
                    }
                    jg_sa1.createChart(0.0, 2000.0);
                    ...
                    jg_ga1.createChart(0.0, 100.0);*/

                    /*JGraph jg_pop = new JGraph(st, "Genetic Algorithms");
                    for(int i = ga_trainingErr.size()/2 - 1; i < ga_trainingErr.size(); i++) {
                        jg_pop.addToSeries("Training Error", runs.get(i)[1], ga_trainingErr.get(i));
                        jg_pop.addToSeries("Testing Error", runs.get(i)[1], ga_testingErr.get(i));
                    }
                    jg_pop.createChart(0.0, 2000.0);*/
